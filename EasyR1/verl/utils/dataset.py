...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        format_prompt_kwargs: Optional[dict[str, Any]] = None,
        ...
        self.format_prompt_kwargs = self._normalize_format_prompt_kwargs(format_prompt_kwargs or {})
    ...
    @staticmethod
    def _normalize_format_prompt_kwargs(kwargs: dict[str, Any]) -> dict[str, Any]:
        """Coerce CLI/OmegaConf string booleans so Jinja {% if %} works as expected."""
    ...
    def _render_format_prompt(self, prompt_str: str) -> str:
        if not self.format_prompt:
            return prompt_str
        template = Template(self.format_prompt.strip())
        return template.render(content=prompt_str, **self.format_prompt_kwargs)

    def _build_messages(self, example: dict[str, Any]) -> list[dict[str, Any]]:
        prompt_str: str = example[self.prompt_key]
        prompt_str = self._render_format_prompt(prompt_str)
